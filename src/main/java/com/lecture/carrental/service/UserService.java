...
import com.lecture.carrental.domain.dto.AdminDTO;
import com.lecture.carrental.domain.dto.UserDTO;
...
public class UserService {
    ...
    private final static String USER_NOT_FOUND_MSG = "user eith id %d not found";
    ...
    public UserDTO findById(Long id) throws ResourceNotFoundException {
        ...
        return new UserDTO(user.getFirstName(), user.getLastName(), user.getPhoneNumber(),
                user.getEmail(), user.getAddress(), user.getZipCode(), user.getBuiltIn(), userDTO.getRoles());
    }
    ...
    public void register(User user) throws BadRequestException {
        ...
        Role customerRole = roleRepository.findByName(UserRole.ROLE_CUSTOMER).orElseThrow(()->new ResourceNotFoundException("Error : Role is not found."));
    ...
    public void updateUser(Long id, UserDTO userDTO) throws BadRequestException {
        ...
        userRepository.update(id, userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(), userDTO.getPhoneNumber(), userDTO.getAddress(), userDTO.getZipCode());
    ...
    public void updateUserAuth(Long id, AdminDTO adminDTO) throws BadRequestException {
        ...
        User user = new User(id, adminDTO.getFirstName(), adminDTO.getLastName(), adminDTO.getPassword(),
                adminDTO.getPhoneNumber(), adminDTO.getEmail(), adminDTO.getAddress(), adminDTO.getZipCode(), adminDTO.getBuiltIn(), roles);
